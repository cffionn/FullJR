...
int plotUnfoldedSpectra(const std::string inFileNamePP, const std::string inFileNamePbPb)
{
  ...
  */
  ...
  TH1D* jtPtUnfolded_RecoGenAsymm_PbPb_h[nJtMax][nMaxCentBins][nMaxID][nMaxResponseMod][nMaxJtAbsEtaBins][nMaxSyst][nBayesCap];
  ...
  TH1D* jtPtUnfolded_RecoGenAsymm_PP_h[nJtMax][nMaxID][nMaxResponseMod][nMaxJtAbsEtaBins][nMaxSyst][nBayesCap];
