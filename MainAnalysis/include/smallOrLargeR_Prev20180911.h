...
class smallOrLargeR
{
 public:
  ...
  //  static const int nGenJtPtBinsSmallR = 8;
  //  std::vector<double> genJtPtBinsSmallR = {100., 150., 200., 250., 300., 400., 600., 1000., 1500.};
  ...
  //  static const int nGenJtPtBinsLargeR = 6;
  //  std::vector<double> genJtPtBinsLargeR = {200., 250., 300., 400., 600., 1000., 1500.};
